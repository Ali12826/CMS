                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="text-center" style="margin-bottom: 30px;">
                            <h3 style="color: #001f3f; font-weight: 700;">Update Security Credentials</h3>
                            <p class="text-muted">Enter a new password to update your account.</p>
                        </div>
