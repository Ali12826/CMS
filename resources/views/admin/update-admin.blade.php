...
/* Card Style for Form (Modern and Clean) */
.task-card {
    background: white;
    border-radius: 15px;
    ...
    <div class="col-md-12">
        <div class="container-fluid">
            <div class="task-header">
                <h2><i class="fa fa-user-circle"></i> Edit Employee Account</h2>
                <p style="margin: 5px 0 0 0; opacity: 0.9;">Update employee details and manage credentials</p>
            </div>
            ...
            <div class="task-card"> 
                <div class="row">
                    <div class="col-md-7">
                        <h3 style="margin-top: 0; margin-bottom: 15px; color: #667eea;"><i class="fa fa-info-circle"></i> Employee Details</h3>
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input type="text" value="<?php echo htmlspecialchars($row['fullname'] ?? ''); ?>" placeholder="Enter Employee Name" name="em_fullname" class="form-control" required>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input type="text" value="<?php echo htmlspecialchars($row['username'] ?? ''); ?>" placeholder="Enter Employee Username" name="em_username" class="form-control" required>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <input type="tel" value="<?php echo htmlspecialchars($row['contact'] ?? ''); ?>" placeholder="Enter employee contact" name="em_email" class="form-control" required>
                              </div>
                            </div>
                    ...
                    <div class="col-md-5" style="border-left: 1px solid #eee; padding-left: 30px;">
                        ...
                        <button id="emlpoyee_pass_btn" class="btn btn-primary"><i class="fa fa-unlock-alt"></i> Change Password</button>
                        
                        <form action="" method="POST" id="employee_pass_cng" style="display: none; margin-top: 15px;">
                            <div class="form-group">
                                <label for="employee_password">New Password:</label>
                                <input type="password" name="employee_password" class="form-control" id="employee_password" minlength="8" required>
                            </div>
                            <div class="form-group">
